# input1_layer15 `05_visipruner_similarity_check.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer15/onnx/05_visipruner_similarity_check.onnx`
...
- Dispatch input tensor ids: `['t00001073', 't00000057', 't00001111', 't00001121', 't00001120', 't00001123', 't00001126']`
- Dispatch output tensor ids: `['t00001124', 't00001127']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00001074', 'consumer_event_op_index': 22, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00001107', 'consumer_event_op_index': 59, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00001122', 'consumer_event_op_index': 77, 'consumer_op_name': 'cosine_similarity.default'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer15/torch_flow/export_stage_onnx.py::VisiPrunerSimilarityCheckStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input1_layer15/torch_flow/visipruner_similarity.py`

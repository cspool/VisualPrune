# input1_layer19 `06_attention_output.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer19/onnx/06_attention_output.onnx`
...
- Dispatch input tensor ids: `['t00001508', 't00001474', 't00001510', 't00001525', 't00001537', 't00001453', 't00001554', 't00001555']`
- Dispatch output tensor ids: `['t00001509', 't00001526', 't00001557']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00001511', 'consumer_event_op_index': 57, 'consumer_op_name': 'reshape.default'}, {'tensor_id': 't00001512', 'consumer_event_op_index': 85, 'consumer_op_name': 'linear.default'}, {'tensor_id': 't00001538', 'consumer_event_op_index': 86, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00001539', 'consumer_event_op_index': 100, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00001556', 'consumer_event_op_index': 100, 'consumer_op_name': 'add.Tensor'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer19/torch_flow/export_stage_onnx.py::AttentionOutputStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input1_layer19/torch_flow/attention_output.py`

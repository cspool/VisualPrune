# input1_layer19 `01_input_rmsnorm.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer19/onnx/01_input_rmsnorm.onnx`
- Stage: `input_rmsnorm`
...
- Dispatch input tensor ids: `['t00001453', 't00001461']`
- Dispatch output tensor ids: `['t00001462']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00001454', 'consumer_event_op_index': 2, 'consumer_op_name': 'pow.Tensor_Scalar'}, {'tensor_id': 't00001455', 'consumer_event_op_index': 3, 'consumer_op_name': 'mean.dim'}, {'tensor_id': 't00001456', 'consumer_event_op_index': 4, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00001457', 'consumer_event_op_index': 5, 'consumer_op_name': 'rsqrt.default'}, {'tensor_id': 't00001454', 'consumer_event_op_index': 6, 'consumer_op_name': 'mul.Tensor'}, {'tensor_id': 't00001458', 'consumer_event_op_index': 6, 'consumer_op_name': 'mul.Tensor'}, {'tensor_id': 't00001459', 'consumer_event_op_index': 7, 'consumer_op_name': 'to.dtype'}, {'tensor_id': 't00001460', 'consumer_event_op_index': 8, 'consumer_op_name': 'mul.Tensor'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer19/torch_flow/export_stage_onnx.py::InputRMSNormStage`

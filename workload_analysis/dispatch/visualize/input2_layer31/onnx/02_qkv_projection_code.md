# input2_layer31 `02_qkv_projection.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input2_layer31/onnx/02_qkv_projection.onnx`
...
- Dispatch input tensor ids: `['t00002755', 't00002756', 't00002758', 't00002760']`
- Dispatch output tensor ids: `['t00002763', 't00002765', 't00002767']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00002757', 'consumer_event_op_index': 12, 'consumer_op_name': 'view.default'}, {'tensor_id': 't00002762', 'consumer_event_op_index': 13, 'consumer_op_name': 'transpose.int'}, {'tensor_id': 't00002759', 'consumer_event_op_index': 14, 'consumer_op_name': 'view.default'}, {'tensor_id': 't00002764', 'consumer_event_op_index': 15, 'consumer_op_name': 'transpose.int'}, {'tensor_id': 't00002761', 'consumer_event_op_index': 16, 'consumer_op_name': 'view.default'}, {'tensor_id': 't00002766', 'consumer_event_op_index': 17, 'consumer_op_name': 'transpose.int'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input2_layer31/torch_flow/export_stage_onnx.py::QKVProjectionStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input2_layer31/torch_flow/qkv_projection.py`

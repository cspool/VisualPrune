# input2_layer31 `06_attention_output.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input2_layer31/onnx/06_attention_output.onnx`
...
- Dispatch input tensor ids: `['t00002804', 't00002797', 't00002806', 't00002809', 't00002746', 't00002826', 't00002827']`
- Dispatch output tensor ids: `['t00002805', 't00002829']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00002807', 'consumer_event_op_index': 61, 'consumer_op_name': 'linear.default'}, {'tensor_id': 't00002810', 'consumer_event_op_index': 62, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00002811', 'consumer_event_op_index': 76, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00002828', 'consumer_event_op_index': 76, 'consumer_op_name': 'add.Tensor'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input2_layer31/torch_flow/export_stage_onnx.py::AttentionOutputStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input2_layer31/torch_flow/attention_output.py`

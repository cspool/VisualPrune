# input1_layer9 `05_visipruner_similarity_check.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer9/onnx/05_visipruner_similarity_check.onnx`
...
- Dispatch input tensor ids: `['t00000479', 't00000057', 't00000517', 't00000527', 't00000526', 't00000529', 't00000532']`
- Dispatch output tensor ids: `['t00000530', 't00000533']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00000480', 'consumer_event_op_index': 22, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00000513', 'consumer_event_op_index': 59, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00000528', 'consumer_event_op_index': 77, 'consumer_op_name': 'cosine_similarity.default'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer9/torch_flow/export_stage_onnx.py::VisiPrunerSimilarityCheckStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input1_layer9/torch_flow/visipruner_similarity.py`

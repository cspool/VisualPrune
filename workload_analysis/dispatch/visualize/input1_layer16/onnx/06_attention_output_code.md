# input1_layer16 `06_attention_output.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer16/onnx/06_attention_output.onnx`
...
- Dispatch input tensor ids: `['t00001201', 't00001169', 't00001203', 't00001215', 't00001227', 't00001148', 't00001244', 't00001245']`
- Dispatch output tensor ids: `['t00001202', 't00001216', 't00001247']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00001204', 'consumer_event_op_index': 57, 'consumer_op_name': 'reshape.default'}, {'tensor_id': 't00001205', 'consumer_event_op_index': 82, 'consumer_op_name': 'linear.default'}, {'tensor_id': 't00001228', 'consumer_event_op_index': 83, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00001229', 'consumer_event_op_index': 97, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00001246', 'consumer_event_op_index': 97, 'consumer_op_name': 'add.Tensor'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer16/torch_flow/export_stage_onnx.py::AttentionOutputStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input1_layer16/torch_flow/attention_output.py`

# input1_layer21 `05_visipruner_similarity_check.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer21/onnx/05_visipruner_similarity_check.onnx`
...
- Dispatch input tensor ids: `['t00001683', 't00000057', 't00001720', 't00001721', 't00001724', 't00001734', 't00001733', 't00001736', 't00001739']`
- Dispatch output tensor ids: `['t00001722', 't00001732', 't00001737', 't00001740']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00001684', 'consumer_event_op_index': 22, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00001717', 'consumer_event_op_index': 59, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00001735', 'consumer_event_op_index': 80, 'consumer_op_name': 'cosine_similarity.default'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer21/torch_flow/export_stage_onnx.py::VisiPrunerSimilarityCheckStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input1_layer21/torch_flow/visipruner_similarity.py`

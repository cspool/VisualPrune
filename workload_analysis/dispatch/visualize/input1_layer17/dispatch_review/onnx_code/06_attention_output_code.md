# input1_layer17 `06_attention_output.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer17/onnx/06_attention_output.onnx`
...
- Dispatch input tensor ids: `['t00001300', 't00001268', 't00001302', 't00001314', 't00001326', 't00001247', 't00001343', 't00001344']`
- Dispatch output tensor ids: `['t00001301', 't00001315', 't00001346']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00001303', 'consumer_event_op_index': 57, 'consumer_op_name': 'reshape.default'}, {'tensor_id': 't00001304', 'consumer_event_op_index': 82, 'consumer_op_name': 'linear.default'}, {'tensor_id': 't00001327', 'consumer_event_op_index': 83, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00001328', 'consumer_event_op_index': 97, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00001345', 'consumer_event_op_index': 97, 'consumer_op_name': 'add.Tensor'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer17/torch_flow/export_stage_onnx.py::AttentionOutputStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input1_layer17/torch_flow/attention_output.py`

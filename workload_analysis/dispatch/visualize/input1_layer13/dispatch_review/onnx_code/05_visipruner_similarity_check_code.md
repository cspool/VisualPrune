# input1_layer13 `05_visipruner_similarity_check.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer13/onnx/05_visipruner_similarity_check.onnx`
...
- Dispatch input tensor ids: `['t00000875', 't00000057', 't00000913', 't00000923', 't00000922', 't00000925', 't00000928']`
- Dispatch output tensor ids: `['t00000926', 't00000929']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00000876', 'consumer_event_op_index': 22, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00000909', 'consumer_event_op_index': 59, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00000924', 'consumer_event_op_index': 77, 'consumer_op_name': 'cosine_similarity.default'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer13/torch_flow/export_stage_onnx.py::VisiPrunerSimilarityCheckStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input1_layer13/torch_flow/visipruner_similarity.py`

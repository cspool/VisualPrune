# input1_layer10 `05_visipruner_similarity_check.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input1_layer10/onnx/05_visipruner_similarity_check.onnx`
...
- Dispatch input tensor ids: `['t00000578', 't00000057', 't00000616', 't00000626', 't00000625', 't00000628', 't00000631']`
- Dispatch output tensor ids: `['t00000629', 't00000632']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00000579', 'consumer_event_op_index': 22, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00000612', 'consumer_event_op_index': 59, 'consumer_op_name': 'is_nonzero.default'}, {'tensor_id': 't00000627', 'consumer_event_op_index': 77, 'consumer_op_name': 'cosine_similarity.default'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input1_layer10/torch_flow/export_stage_onnx.py::VisiPrunerSimilarityCheckStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input1_layer10/torch_flow/visipruner_similarity.py`

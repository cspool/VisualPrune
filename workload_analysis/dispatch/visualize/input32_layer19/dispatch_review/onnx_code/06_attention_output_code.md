# input32_layer19 `06_attention_output.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input32_layer19/onnx/06_attention_output.onnx`
...
- Dispatch input tensor ids: `['t00002955', 't00002948', 't00002957', 't00001537', 't00002903', 't00002973', 't00001555']`
- Dispatch output tensor ids: `['t00002956', 't00002975']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00002958', 'consumer_event_op_index': 61, 'consumer_op_name': 'linear.default'}, {'tensor_id': 't00002960', 'consumer_event_op_index': 62, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00002961', 'consumer_event_op_index': 76, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00002974', 'consumer_event_op_index': 76, 'consumer_op_name': 'add.Tensor'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input32_layer19/torch_flow/export_stage_onnx.py::AttentionOutputStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input32_layer19/torch_flow/attention_output.py`

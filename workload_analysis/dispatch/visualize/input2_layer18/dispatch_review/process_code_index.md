...
- dispatch reconstruction: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input2_layer18/torch_flow/dispatch_reconstructed.py`
- runnable toy process: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input2_layer18/torch_flow/toy_tensor_compute.py`
- split small-tensor torch flow: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input2_layer18/torch_flow`
...
### `kv_cache_concat`
- `#47 cat.default` -> shape=[1, 32, 625, 128], dtype=float16
- `#48 cat.default` -> shape=[1, 32, 625, 128], dtype=float16
...
- `#49 transpose.int` -> shape=[1, 32, 128, 625], dtype=float16
- `#50 matmul.default` -> shape=[1, 32, 1, 625], dtype=float16
- `#51 div.Tensor` -> shape=[1, 32, 1, 625], dtype=float16
- `#52 add.Tensor` -> shape=[1, 32, 1, 625], dtype=float16
- `#53 softmax.int` -> shape=[1, 32, 1, 625], dtype=float32
- `#55 dropout.default` -> shape=[1, 32, 1, 625], dtype=float16
...
### `mlp`
- `#54 to.dtype` -> shape=[1, 32, 1, 625], dtype=float16
- `#61 linear.default` -> shape=[1, 1, 4096], dtype=float16
- `#62 add.Tensor` -> shape=[1, 1, 4096], dtype=float16

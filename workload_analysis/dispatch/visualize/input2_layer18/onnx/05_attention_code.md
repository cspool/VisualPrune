# input2_layer18 `05_attention.onnx` Code Review

## ONNX Artifact

- ONNX file: `/workspace/VisiPrune/workload_analysis/dispatch/visualize/input2_layer18/onnx/05_attention.onnx`
- Stage: `attention`
...
- Dispatch input tensor ids: `['t00002475', 't00002477', 't00002479', 't00002492', 't00002497', 't00002499', 't00002504', 't00002506', 't00002511', 't00002507']`
- Dispatch output tensor ids: `['t00002476', 't00002478', 't00002480', 't00002505', 't00002513', 't00002515']`
- Dispatch tensor-id dependencies inside evidence rows: `[{'tensor_id': 't00002498', 'consumer_event_op_index': 50, 'consumer_op_name': 'matmul.default'}, {'tensor_id': 't00002508', 'consumer_event_op_index': 50, 'consumer_op_name': 'matmul.default'}, {'tensor_id': 't00002509', 'consumer_event_op_index': 51, 'consumer_op_name': 'div.Tensor'}, {'tensor_id': 't00002510', 'consumer_event_op_index': 52, 'consumer_op_name': 'add.Tensor'}, {'tensor_id': 't00002512', 'consumer_event_op_index': 53, 'consumer_op_name': 'softmax.int'}, {'tensor_id': 't00002514', 'consumer_event_op_index': 56, 'consumer_op_name': 'matmul.default'}]`

## Corresponding `torch_flow` Code

- Export wrapper: `workload_analysis/dispatch/visualize/input2_layer18/torch_flow/export_stage_onnx.py::AttentionStage`
- Primary implementation: `workload_analysis/dispatch/visualize/input2_layer18/torch_flow/attention.py`

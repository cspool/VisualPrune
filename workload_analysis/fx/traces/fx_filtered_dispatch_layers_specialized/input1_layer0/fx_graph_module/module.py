...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.register_buffer('_tensor_constant2', torch.empty([], dtype=torch.float16))
        ...
        self.load_state_dict(torch.load(r'/workspace/VisiPrune/workload_analysis/fx/traces/fx_filtered_dispatch_layers_specialized/input1_layer0/fx_graph_module/state_dict.pt'))
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1):
        ...
        slice_7 = torch.ops.aten.slice.Tensor(_to_copy_2, 2, 611, 9223372036854775807)
        slice_8 = torch.ops.aten.slice.Tensor(slice_7, 3, 35, 611);  slice_7 = None
        sum_1 = torch.ops.aten.sum.dim_IntList(slice_8, [-1]);  slice_8 = None
        _tensor_constant2 = self._tensor_constant2
        lift_fresh_copy = torch.ops.aten.lift_fresh_copy.default(_tensor_constant2);  _tensor_constant2 = None
        slice_9 = torch.ops.aten.slice.Tensor(_to_copy_2, 2, 35, 9223372036854775807)
        slice_10 = torch.ops.aten.slice.Tensor(slice_9, 3, 35, 611);  slice_9 = None
        fill_ = torch.ops.aten.fill_.Tensor(slice_10, lift_fresh_copy);  slice_10 = lift_fresh_copy = fill_ = None
        slice_11 = torch.ops.aten.slice.Tensor(_to_copy_2, 2, 611, 9223372036854775807)
        select = torch.ops.aten.select.int(slice_11, 3, 35);  slice_11 = None
        copy_ = torch.ops.aten.copy_.default(select, sum_1);  select = sum_1 = copy_ = None

...
_tensor_constant221 = self._tensor_constant221
mm_default = aten.mm.default(view_default, _tensor_constant221)
...
_tensor_constant222 = self._tensor_constant222
mm_default_1 = aten.mm.default(view_default_1, _tensor_constant222)
...
_tensor_constant223 = self._tensor_constant223
mm_default_2 = aten.mm.default(view_default_2, _tensor_constant223)
...
怎么做/计算：`mul_tensor_1` 用 `_param_constant0` 对 `_to_copy_default_1` 做 Hidden 维逐元素缩放；Q/K/V 三个分支分别把 `mul_tensor_1` `view` 成 `[624,4096]`，再用 `_tensor_constant221/222/223` 做 `mm` 得到 `[624,4096]` 投影，随后 `_unsafe_view` 恢复 batch 维；`view_default_3/4/5` 把 Hidden 维拆成 `[Heads=32,Dh=128]`；`transpose_int/1/2` 把布局从 `[B,S,Heads,Dh]` 转为 `[B,Heads,S,Dh]`，供 attention 使用。
...
examples: Q_h[0,0,0], K_h[31,611,127], V_h[8,623,64].
```

### RoPE position embedding

```python
_tensor_constant224 = self._tensor_constant224
index_tensor = aten.index.Tensor(_tensor_constant224, [arg2_1])
unsqueeze_default = aten.unsqueeze.default(index_tensor, 1)
_tensor_constant225 = self._tensor_constant225
index_tensor_1 = aten.index.Tensor(_tensor_constant225, [arg2_1])
...
_tensor_constant226 = self._tensor_constant226
mm_default_3 = aten.mm.default(view_default_14, _tensor_constant226)
...
怎么做/计算：`view_default_14` 把 `view_default_12` 展平为 `[624,4096]`；`mm_default_3` 与 `_tensor_constant226` 做输出投影，仍是 `[624,4096]`；`_unsafe_view_default_3` 恢复 `[1,624,4096]`；`add_tensor_4` 在相同 S/H 坐标上执行 `arg0_1 + projected_context`，形成 post-attention residual。
...
```python
_tensor_constant227 = self._tensor_constant227
mm_default_4 = aten.mm.default(view_default_15, _tensor_constant227)
...
_tensor_constant228 = self._tensor_constant228
mm_default_5 = aten.mm.default(view_default_16, _tensor_constant228)
...
_tensor_constant229 = self._tensor_constant229
mm_default_6 = aten.mm.default(view_default_17, _tensor_constant229)
...
怎么做/计算：`mm_default_4` 使用 `view_default_15` 和 `_tensor_constant227` 产生 gate projection `[624,11008]`，`_unsafe_view_default_4` 恢复 batch 维，`silu_default` 对 gate 做 SiLU；`view_default_16` 从同一个 `mul_tensor_8` 得到 up 分支输入，`mm_default_5` 与 `_tensor_constant228` 产生 up projection `[624,11008]`；`mul_tensor_9` 在同一 S/I 坐标上计算 `silu(gate) * up`；`view_default_17` 展平后，`mm_default_6` 与 `_tensor_constant229` down project 回 `[624,4096]`；`_unsafe_view_default_6` 恢复 batch 维；`add_tensor_6` 与 `add_tensor_4` 在同一 S/H 坐标上做最终 residual add。
...
examples: K_cache[0,0,0], K_cache[31,623,127], V_cache[8,611,64].
```
...
| 18 | `qkv_projection` | `_tensor_constant221` | `get_attr` | `_tensor_constant221` | - | `mm_default` |
| 19 | `qkv_projection` | `mm_default` | `call_function` | `aten.mm.default` | `view_default`, `_tensor_constant221` | `_unsafe_view_default` |
...
| 22 | `qkv_projection` | `_tensor_constant222` | `get_attr` | `_tensor_constant222` | - | `mm_default_1` |
| 23 | `qkv_projection` | `mm_default_1` | `call_function` | `aten.mm.default` | `view_default_1`, `_tensor_constant222` | `_unsafe_view_default_1` |
...
| 26 | `qkv_projection` | `_tensor_constant223` | `get_attr` | `_tensor_constant223` | - | `mm_default_2` |
| 27 | `qkv_projection` | `mm_default_2` | `call_function` | `aten.mm.default` | `view_default_2`, `_tensor_constant223` | `_unsafe_view_default_2` |
...
| 35 | `rope` | `_tensor_constant224` | `get_attr` | `_tensor_constant224` | - | `index_tensor` |
| 36 | `rope` | `index_tensor` | `call_function` | `aten.index.Tensor` | `_tensor_constant224`, `arg2_1` | `unsqueeze_default` |
| 37 | `rope` | `unsqueeze_default` | `call_function` | `aten.unsqueeze.default` | `index_tensor` | `mul_tensor_2`, `mul_tensor_4` |
| 38 | `rope` | `_tensor_constant225` | `get_attr` | `_tensor_constant225` | - | `index_tensor_1` |
| 39 | `rope` | `index_tensor_1` | `call_function` | `aten.index.Tensor` | `_tensor_constant225`, `arg2_1` | `unsqueeze_default_1` |
...
| 87 | `output_projection` | `_tensor_constant226` | `get_attr` | `_tensor_constant226` | - | `mm_default_3` |
| 88 | `output_projection` | `mm_default_3` | `call_function` | `aten.mm.default` | `view_default_14`, `_tensor_constant226` | `_unsafe_view_default_3` |
...
| 101 | `mlp` | `_tensor_constant227` | `get_attr` | `_tensor_constant227` | - | `mm_default_4` |
| 102 | `mlp` | `mm_default_4` | `call_function` | `aten.mm.default` | `view_default_15`, `_tensor_constant227` | `_unsafe_view_default_4` |
...
| 106 | `mlp` | `_tensor_constant228` | `get_attr` | `_tensor_constant228` | - | `mm_default_5` |
| 107 | `mlp` | `mm_default_5` | `call_function` | `aten.mm.default` | `view_default_16`, `_tensor_constant228` | `_unsafe_view_default_5` |
...
| 111 | `mlp` | `_tensor_constant229` | `get_attr` | `_tensor_constant229` | - | `mm_default_6` |
| 112 | `mlp` | `mm_default_6` | `call_function` | `aten.mm.default` | `view_default_17`, `_tensor_constant229` | `_unsafe_view_default_6` |

...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load(r'/workspace/VisiPrune/workload_analysis/fx/traces/fx_filtered_dispatch_layers_specialized/input1_layer18/fx_graph_module/state_dict.pt'))
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1):
        ...
        expand_2 = torch.ops.aten.expand.default(clone, [1, 32, 624, 624])
        ...
        view_13 = torch.ops.aten.view.default(clone_2, [1, 624, -1]);  clone_2 = None
        slice_7 = torch.ops.aten.slice.Tensor(view_13, 1, 35, 611);  view_13 = None
        unsqueeze_3 = torch.ops.aten.unsqueeze.default(select, 1)
        sub = torch.ops.aten.sub.Tensor(unsqueeze_3, slice_7);  unsqueeze_3 = slice_7 = None
        unsqueeze_4 = torch.ops.aten.unsqueeze.default(select, 1);  select = None
        sub_1 = torch.ops.aten.sub.Tensor(sub, unsqueeze_4);  sub = unsqueeze_4 = None
        linalg_vector_norm = torch.ops.aten.linalg_vector_norm.default(sub_1, 2, [-1]);  sub_1 = None
        squeeze = torch.ops.aten.squeeze.dim(linalg_vector_norm, 0);  linalg_vector_norm = None
        gt = torch.ops.aten.gt.Scalar(squeeze, 0.2);  squeeze = None
        nonzero = torch.ops.aten.nonzero.default(gt);  gt = None
        unbind = torch.ops.aten.unbind.int(nonzero, 1);  nonzero = None
        getitem = unbind[0];  unbind = None
        add_4 = torch.ops.aten.add.Tensor(getitem, 35);  getitem = None
        _param_constant4 = self._param_constant4
        t_3 = torch.ops.aten.t.default(_param_constant4);  _param_constant4 = None
        view_14 = torch.ops.aten.view.default(view_12, [624, 4096]);  view_12 = None
        ...
        add_5 = torch.ops.aten.add.Tensor(arg0_1, _unsafe_view_3);  arg0_1 = _unsafe_view_3 = None
        _to_copy_3 = torch.ops.aten._to_copy.default(add_5, dtype = torch.float32)
        pow_2 = torch.ops.aten.pow.Tensor_Scalar(_to_copy_3, 2)
        mean_1 = torch.ops.aten.mean.dim(pow_2, [-1], True);  pow_2 = None
        add_6 = torch.ops.aten.add.Tensor(mean_1, 1e-05);  mean_1 = None
        ...
        view_15 = torch.ops.aten.view.default(mul_8, [624, 4096])
        ...
        view_16 = torch.ops.aten.view.default(mul_8, [624, 4096]);  mul_8 = None
        ...
        view_17 = torch.ops.aten.view.default(mul_9, [624, 11008]);  mul_9 = None
        ...
        add_7 = torch.ops.aten.add.Tensor(add_5, _unsafe_view_6);  add_5 = _unsafe_view_6 = None
        return (add_7, {'dynamic_cache_layer': (add_2, transpose_2)}, add_4, 0)

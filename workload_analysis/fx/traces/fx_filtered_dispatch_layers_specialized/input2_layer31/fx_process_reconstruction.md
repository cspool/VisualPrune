...
Trace directory: `workload_analysis/fx/traces/fx_filtered_dispatch_layers_specialized/input2_layer31`
...
_tensor_constant275 = self._tensor_constant275
mm_default = aten.mm.default(view_default, _tensor_constant275)
_unsafe_view_default = aten._unsafe_view.default(mm_default, [1, 1, 4096])
view_default_1 = aten.view.default(mul_tensor_1, [1, 4096])
_tensor_constant276 = self._tensor_constant276
mm_default_1 = aten.mm.default(view_default_1, _tensor_constant276)
...
_tensor_constant277 = self._tensor_constant277
mm_default_2 = aten.mm.default(view_default_2, _tensor_constant277)
...
怎么做/计算：`mul_tensor_1` 乘 input norm 权重；Q/K/V 三个分支分别 `view -> mm -> _unsafe_view`，使用 `_tensor_constant275/276/277`；再 `view` 成 `[1,1,32,128]`，`transpose` 到 `[1,32,1,128]`。
...
```python
_tensor_constant278 = self._tensor_constant278
index_tensor = aten.index.Tensor(_tensor_constant278, [arg2_1])
unsqueeze_default = aten.unsqueeze.default(index_tensor, 1)
_tensor_constant279 = self._tensor_constant279
index_tensor_1 = aten.index.Tensor(_tensor_constant279, [arg2_1])
...
怎么做/计算：`index_tensor/index_tensor_1` 用 `arg2_1` 从 `_tensor_constant278/279` 取 cos/sin；Q 分支计算 `transpose_int*cos`，把 Dh 轴 `0..63` 和 `64..127` 切开，右半取负并拼回左半形成 rotate-half，乘 sin 后相加；K 分支同样生成 `add_tensor_2`。
...
_tensor_constant280 = self._tensor_constant280
mm_default_3 = aten.mm.default(view_default_13, _tensor_constant280)
...
怎么做/计算：`view_default_13` 展平 context；`mm_default_3` 乘 `_tensor_constant280`；`_unsafe_view_default_3` 恢复 `[1,1,4096]`；`add_tensor_4` 与 `arg0_1` 在同一 H 坐标逐元素相加。
...
```python
_tensor_constant281 = self._tensor_constant281
mm_default_4 = aten.mm.default(view_default_14, _tensor_constant281)
...
_tensor_constant282 = self._tensor_constant282
mm_default_5 = aten.mm.default(view_default_15, _tensor_constant282)
...
_tensor_constant283 = self._tensor_constant283
mm_default_6 = aten.mm.default(view_default_16, _tensor_constant283)
...
examples: K[31,48,127], V[31,48,64], hidden[0,0,4095].
```
...
| 18 | `qkv_projection` | `_tensor_constant275` | `get_attr` | `_tensor_constant275` | - | `mm_default` |
| 19 | `qkv_projection` | `mm_default` | `call_function` | `aten.mm.default` | `view_default`, `_tensor_constant275` | `_unsafe_view_default` |
...
| 22 | `qkv_projection` | `_tensor_constant276` | `get_attr` | `_tensor_constant276` | - | `mm_default_1` |
| 23 | `qkv_projection` | `mm_default_1` | `call_function` | `aten.mm.default` | `view_default_1`, `_tensor_constant276` | `_unsafe_view_default_1` |
...
| 26 | `qkv_projection` | `_tensor_constant277` | `get_attr` | `_tensor_constant277` | - | `mm_default_2` |
| 27 | `qkv_projection` | `mm_default_2` | `call_function` | `aten.mm.default` | `view_default_2`, `_tensor_constant277` | `_unsafe_view_default_2` |
...
| 35 | `rope` | `_tensor_constant278` | `get_attr` | `_tensor_constant278` | - | `index_tensor` |
| 36 | `rope` | `index_tensor` | `call_function` | `aten.index.Tensor` | `_tensor_constant278`, `arg2_1` | `unsqueeze_default` |
| 37 | `rope` | `unsqueeze_default` | `call_function` | `aten.unsqueeze.default` | `index_tensor` | `mul_tensor_2`, `mul_tensor_4` |
| 38 | `rope` | `_tensor_constant279` | `get_attr` | `_tensor_constant279` | - | `index_tensor_1` |
| 39 | `rope` | `index_tensor_1` | `call_function` | `aten.index.Tensor` | `_tensor_constant279`, `arg2_1` | `unsqueeze_default_1` |
...
| 80 | `output_projection` | `_tensor_constant280` | `get_attr` | `_tensor_constant280` | - | `mm_default_3` |
| 81 | `output_projection` | `mm_default_3` | `call_function` | `aten.mm.default` | `view_default_13`, `_tensor_constant280` | `_unsafe_view_default_3` |
...
| 94 | `mlp` | `_tensor_constant281` | `get_attr` | `_tensor_constant281` | - | `mm_default_4` |
| 95 | `mlp` | `mm_default_4` | `call_function` | `aten.mm.default` | `view_default_14`, `_tensor_constant281` | `_unsafe_view_default_4` |
...
| 99 | `mlp` | `_tensor_constant282` | `get_attr` | `_tensor_constant282` | - | `mm_default_5` |
| 100 | `mlp` | `mm_default_5` | `call_function` | `aten.mm.default` | `view_default_15`, `_tensor_constant282` | `_unsafe_view_default_5` |
...
| 104 | `mlp` | `_tensor_constant283` | `get_attr` | `_tensor_constant283` | - | `mm_default_6` |
| 105 | `mlp` | `mm_default_6` | `call_function` | `aten.mm.default` | `view_default_16`, `_tensor_constant283` | `_unsafe_view_default_6` |

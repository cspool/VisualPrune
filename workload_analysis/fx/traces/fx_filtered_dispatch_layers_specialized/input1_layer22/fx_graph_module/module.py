...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load(r'/workspace/VisiPrune/workload_analysis/fx/traces/fx_filtered_dispatch_layers_specialized/input1_layer22/fx_graph_module/state_dict.pt'))
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1):
        ...
        view = torch.ops.aten.view.default(mul_1, [58, 4096])
        mm = torch.ops.aten.mm.default(view, t);  view = t = None
        _unsafe_view = torch.ops.aten._unsafe_view.default(mm, [1, 58, 4096]);  mm = None
        _param_constant2 = self._param_constant2
        t_1 = torch.ops.aten.t.default(_param_constant2);  _param_constant2 = None
        view_1 = torch.ops.aten.view.default(mul_1, [58, 4096])
        mm_1 = torch.ops.aten.mm.default(view_1, t_1);  view_1 = t_1 = None
        _unsafe_view_1 = torch.ops.aten._unsafe_view.default(mm_1, [1, 58, 4096]);  mm_1 = None
        _param_constant3 = self._param_constant3
        t_2 = torch.ops.aten.t.default(_param_constant3);  _param_constant3 = None
        view_2 = torch.ops.aten.view.default(mul_1, [58, 4096]);  mul_1 = None
        mm_2 = torch.ops.aten.mm.default(view_2, t_2);  view_2 = t_2 = None
        _unsafe_view_2 = torch.ops.aten._unsafe_view.default(mm_2, [1, 58, 4096]);  mm_2 = None
        view_3 = torch.ops.aten.view.default(_unsafe_view, [1, 58, 32, 128]);  _unsafe_view = None
        transpose = torch.ops.aten.transpose.int(view_3, 1, 2);  view_3 = None
        view_4 = torch.ops.aten.view.default(_unsafe_view_1, [1, 58, 32, 128]);  _unsafe_view_1 = None
        transpose_1 = torch.ops.aten.transpose.int(view_4, 1, 2);  view_4 = None
        view_5 = torch.ops.aten.view.default(_unsafe_view_2, [1, 58, 32, 128]);  _unsafe_view_2 = None
        ...
        expand = torch.ops.aten.expand.default(add_1, [1, 32, 58, 128]);  add_1 = None
        view_6 = torch.ops.aten.view.default(expand, [32, 58, 128]);  expand = None
        expand_1 = torch.ops.aten.expand.default(transpose_3, [1, 32, 128, 58]);  transpose_3 = None
        view_7 = torch.ops.aten.view.default(expand_1, [32, 128, 58]);  expand_1 = None
        bmm = torch.ops.aten.bmm.default(view_6, view_7);  view_6 = view_7 = None
        view_8 = torch.ops.aten.view.default(bmm, [1, 32, 58, 58]);  bmm = None
        ...
        expand_2 = torch.ops.aten.expand.default(clone, [1, 32, 58, 58])
        view_9 = torch.ops.aten.view.default(expand_2, [32, 58, 58]);  expand_2 = None
        expand_3 = torch.ops.aten.expand.default(transpose_2, [1, 32, 58, 128])
        view_10 = torch.ops.aten.view.default(expand_3, [32, 58, 128]);  expand_3 = None
        bmm_1 = torch.ops.aten.bmm.default(view_9, view_10);  view_9 = view_10 = None
        view_11 = torch.ops.aten.view.default(bmm_1, [1, 32, 58, 128]);  bmm_1 = None
        ...
        view_12 = torch.ops.aten.view.default(clone_1, [1, 58, 4096]);  clone_1 = None
        select = torch.ops.aten.select.int(view_12, 1, -1)
        select_1 = torch.ops.aten.select.int(clone, 2, -1);  clone = None
        unsqueeze_2 = torch.ops.aten.unsqueeze.default(select_1, 3);  select_1 = None
        mul_6 = torch.ops.aten.mul.Tensor(unsqueeze_2, transpose_2);  unsqueeze_2 = None
        permute = torch.ops.aten.permute.default(mul_6, [0, 2, 1, 3]);  mul_6 = None
        clone_2 = torch.ops.aten.clone.default(permute, memory_format = torch.contiguous_format);  permute = None
        view_13 = torch.ops.aten.view.default(clone_2, [1, 58, -1]);  clone_2 = None
        arange = torch.ops.aten.arange.start(35, 45, device = device(type='cuda', index=0), pin_memory = False)
        index_2 = torch.ops.aten.index.Tensor(view_13, [None, arange]);  view_13 = arange = None
        unsqueeze_3 = torch.ops.aten.unsqueeze.default(select, 1);  select = None
        sub = torch.ops.aten.sub.Tensor(unsqueeze_3, index_2);  unsqueeze_3 = index_2 = sub = None
        _param_constant4 = self._param_constant4
        t_3 = torch.ops.aten.t.default(_param_constant4);  _param_constant4 = None
        view_14 = torch.ops.aten.view.default(view_12, [58, 4096]);  view_12 = None
        mm_3 = torch.ops.aten.mm.default(view_14, t_3);  view_14 = t_3 = None
        _unsafe_view_3 = torch.ops.aten._unsafe_view.default(mm_3, [1, 58, 4096]);  mm_3 = None
        ...
        mul_7 = torch.ops.aten.mul.Tensor(_to_copy_3, rsqrt_1);  _to_copy_3 = rsqrt_1 = None
        _to_copy_4 = torch.ops.aten._to_copy.default(mul_7, dtype = torch.float16);  mul_7 = None
        _param_constant5 = self._param_constant5
        mul_8 = torch.ops.aten.mul.Tensor(_param_constant5, _to_copy_4);  _param_constant5 = _to_copy_4 = None
        _param_constant6 = self._param_constant6
        t_4 = torch.ops.aten.t.default(_param_constant6);  _param_constant6 = None
        view_15 = torch.ops.aten.view.default(mul_8, [58, 4096])
        mm_4 = torch.ops.aten.mm.default(view_15, t_4);  view_15 = t_4 = None
        _unsafe_view_4 = torch.ops.aten._unsafe_view.default(mm_4, [1, 58, 11008]);  mm_4 = None
        ...
        view_16 = torch.ops.aten.view.default(mul_8, [58, 4096]);  mul_8 = None
        mm_5 = torch.ops.aten.mm.default(view_16, t_5);  view_16 = t_5 = None
        _unsafe_view_5 = torch.ops.aten._unsafe_view.default(mm_5, [1, 58, 11008]);  mm_5 = None
        mul_9 = torch.ops.aten.mul.Tensor(silu, _unsafe_view_5);  silu = _unsafe_view_5 = None
        _param_constant8 = self._param_constant8
        t_6 = torch.ops.aten.t.default(_param_constant8);  _param_constant8 = None
        view_17 = torch.ops.aten.view.default(mul_9, [58, 11008]);  mul_9 = None
        mm_6 = torch.ops.aten.mm.default(view_17, t_6);  view_17 = t_6 = None
        _unsafe_view_6 = torch.ops.aten._unsafe_view.default(mm_6, [1, 58, 4096]);  mm_6 = None
        add_6 = torch.ops.aten.add.Tensor(add_4, _unsafe_view_6);  add_4 = _unsafe_view_6 = None
        return (add_6, {'dynamic_cache_layer': (add_2, transpose_2)}, arg6_1, 0)

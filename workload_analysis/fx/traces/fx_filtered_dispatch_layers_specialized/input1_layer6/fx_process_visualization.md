...
- 是什么: #0-#7 是该固定输入 FX DAG 的 placeholder。`arg0_1` 是 `[1,624,4096]` hidden states，`arg1_1` 是 `[1,1,624,624]` attention mask，`arg2_1` 是 position ids。
...
- 是什么: #16-#34 将 normalized hidden 投影为 Q、K、V，并转成 `[1,32,624,128]` head layout。
...
- 怎么做/计算: #55 转置 K 的最后两维；#56/#57 将 Q 变为 `[32,624,128]`；#58/#59 将 K^T 变为 `[32,128,624]`；#60 `bmm` 得到 `[32,624,624]`；#61 view 为 `[1,32,624,624]`；#62 除以 `sqrt(128)`；#63 加 mask；#64 softmax；#65 转 fp16；#66 clone 后作为 attention weights。
...
- 是什么: #67-#75 用 attention weights 加权 V，并把多头 context 合并回 `[1,624,4096]`。
- 为什么需要: Attention weights 本身不是 hidden output；`weights @ V` 才是 attention 子层的上下文表示。
- 怎么做/计算: #67/#68 把 #66 weights 变为 `[32,624,624]`；#69/#70 把 V 变为 `[32,624,128]`；#71 `bmm` 沿 K 维求和；#72 view 为 `[1,32,624,128]`；#73 transpose；#74 clone；#75 view 为 `[1,624,4096]`。
...
- 怎么做/计算: #76 view 为 `[624,4096]`；#77 读取 projection 权重；#78 `mm`；#79 reshape 为 `[1,624,4096]`；#80 与 `arg0_1` 相加。
...
- 怎么做/计算: #81 转 fp32；#82 平方；#83 沿 Hidden 均值；#84 加 epsilon；#85 `rsqrt`；#86 乘回 residual hidden；#87 转 fp16；#88 读取 norm weight；#89 逐元素乘；#90 view 成 `[624,4096]`。
...
- 怎么做/计算: #91/#92 做 gate projection；#93 reshape 到 `[1,624,11008]`；#94 `silu`；#95-#98 做 up projection；#99 将 gate activation 与 up projection 相乘；#100 view `[624,11008]`；#101/#102 down projection；#103 reshape 回 hidden；#104 与 #80 residual 相加。

```text
Per-token channel transform H=4096 -> I=11008 -> H=4096
                                                       0                                      11008
                                                       ▲                                        ▲
mlp input       #90 [624,4096]                ──▶    ┌────────────────────────────────────────┐
                                                       │ NORMALIZED_MLP_INPUT_ROWS             │
                                                       │ NORMALIZED_MLP_INPUT_ROWS             │
                                                       └────────────────────────────────────────┘
gate/up         #91-#98                       ──▶    ┌────────────────────────────────────────┐
...
hidden_states      #104 add_tensor_6             ──▶   [OUTPUT_HIDDEN_ROWS: B=1,S=624,H=4096]

...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load(r'/workspace/VisiPrune/workload_analysis/fx/traces/fx_filtered_dispatch_layers_specialized/input1_layer28/fx_graph_module/state_dict.pt'))
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1):
        ...
        view = torch.ops.aten.view.default(mul_1, [48, 4096])
        mm = torch.ops.aten.mm.default(view, t);  view = t = None
        _unsafe_view = torch.ops.aten._unsafe_view.default(mm, [1, 48, 4096]);  mm = None
        _param_constant2 = self._param_constant2
        t_1 = torch.ops.aten.t.default(_param_constant2);  _param_constant2 = None
        view_1 = torch.ops.aten.view.default(mul_1, [48, 4096])
        mm_1 = torch.ops.aten.mm.default(view_1, t_1);  view_1 = t_1 = None
        _unsafe_view_1 = torch.ops.aten._unsafe_view.default(mm_1, [1, 48, 4096]);  mm_1 = None
        _param_constant3 = self._param_constant3
        t_2 = torch.ops.aten.t.default(_param_constant3);  _param_constant3 = None
        view_2 = torch.ops.aten.view.default(mul_1, [48, 4096]);  mul_1 = None
        mm_2 = torch.ops.aten.mm.default(view_2, t_2);  view_2 = t_2 = None
        _unsafe_view_2 = torch.ops.aten._unsafe_view.default(mm_2, [1, 48, 4096]);  mm_2 = None
        view_3 = torch.ops.aten.view.default(_unsafe_view, [1, 48, 32, 128]);  _unsafe_view = None
        transpose = torch.ops.aten.transpose.int(view_3, 1, 2);  view_3 = None
        view_4 = torch.ops.aten.view.default(_unsafe_view_1, [1, 48, 32, 128]);  _unsafe_view_1 = None
        transpose_1 = torch.ops.aten.transpose.int(view_4, 1, 2);  view_4 = None
        view_5 = torch.ops.aten.view.default(_unsafe_view_2, [1, 48, 32, 128]);  _unsafe_view_2 = None
        ...
        expand = torch.ops.aten.expand.default(add_1, [1, 32, 48, 128]);  add_1 = None
        view_6 = torch.ops.aten.view.default(expand, [32, 48, 128]);  expand = None
        expand_1 = torch.ops.aten.expand.default(transpose_3, [1, 32, 128, 48]);  transpose_3 = None
        view_7 = torch.ops.aten.view.default(expand_1, [32, 128, 48]);  expand_1 = None
        bmm = torch.ops.aten.bmm.default(view_6, view_7);  view_6 = view_7 = None
        view_8 = torch.ops.aten.view.default(bmm, [1, 32, 48, 48]);  bmm = None
        ...
        expand_2 = torch.ops.aten.expand.default(clone, [1, 32, 48, 48]);  clone = None
        view_9 = torch.ops.aten.view.default(expand_2, [32, 48, 48]);  expand_2 = None
        expand_3 = torch.ops.aten.expand.default(transpose_2, [1, 32, 48, 128])
        view_10 = torch.ops.aten.view.default(expand_3, [32, 48, 128]);  expand_3 = None
        bmm_1 = torch.ops.aten.bmm.default(view_9, view_10);  view_9 = view_10 = None
        view_11 = torch.ops.aten.view.default(bmm_1, [1, 32, 48, 128]);  bmm_1 = None
        ...
        view_12 = torch.ops.aten.view.default(clone_1, [1, 48, 4096]);  clone_1 = None
        _param_constant4 = self._param_constant4
        t_3 = torch.ops.aten.t.default(_param_constant4);  _param_constant4 = None
        view_13 = torch.ops.aten.view.default(view_12, [48, 4096]);  view_12 = None
        mm_3 = torch.ops.aten.mm.default(view_13, t_3);  view_13 = t_3 = None
        _unsafe_view_3 = torch.ops.aten._unsafe_view.default(mm_3, [1, 48, 4096]);  mm_3 = None
        ...
        view_14 = torch.ops.aten.view.default(mul_7, [48, 4096])
        mm_4 = torch.ops.aten.mm.default(view_14, t_4);  view_14 = t_4 = None
        _unsafe_view_4 = torch.ops.aten._unsafe_view.default(mm_4, [1, 48, 11008]);  mm_4 = None
        ...
        view_15 = torch.ops.aten.view.default(mul_7, [48, 4096]);  mul_7 = None
        mm_5 = torch.ops.aten.mm.default(view_15, t_5);  view_15 = t_5 = None
        _unsafe_view_5 = torch.ops.aten._unsafe_view.default(mm_5, [1, 48, 11008]);  mm_5 = None
        ...
        view_16 = torch.ops.aten.view.default(mul_8, [48, 11008]);  mul_8 = None
        mm_6 = torch.ops.aten.mm.default(view_16, t_6);  view_16 = t_6 = None
        _unsafe_view_6 = torch.ops.aten._unsafe_view.default(mm_6, [1, 48, 4096]);  mm_6 = None

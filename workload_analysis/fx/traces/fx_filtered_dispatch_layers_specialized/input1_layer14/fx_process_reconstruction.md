...
Trace directory: `workload_analysis/fx/traces/fx_filtered_dispatch_layers_specialized/input1_layer14`
...
mm_default = aten.mm.default(view_default, _tensor_constant49)
...
mm_default_1 = aten.mm.default(view_default_1, _tensor_constant50)
...
mm_default_2 = aten.mm.default(view_default_2, _tensor_constant51)
...
怎么做/计算：`mul_tensor_1` 乘 input norm 权重；Q/K/V 三个分支分别 `view -> mm -> _unsafe_view`，使用 `_tensor_constant49/50/51`；再 `view` 成 `[1,624,32,128]`，`transpose` 到 `[1,32,624,128]`。
...
examples: Q[0,0,0,0], K[0,31,611,127], V[0,14,623,64].
```
...
index_tensor = aten.index.Tensor(_tensor_constant52, [arg2_1])
unsqueeze_default = aten.unsqueeze.default(index_tensor, 1)
_tensor_constant53 = self._tensor_constant53
index_tensor_1 = aten.index.Tensor(_tensor_constant53, [arg2_1])
...
怎么做/计算：`index_tensor/index_tensor_1` 用 `arg2_1` 从 `_tensor_constant52/53` 取 cos/sin；Q 分支计算 `transpose_int*cos`，再把 Dh 轴 `0..63` 和 `64..127` 切开，右半取负并拼回左半形成 rotate-half，乘 sin 后相加；K 分支同样生成 `add_tensor_2`。
...
mm_default_3 = aten.mm.default(view_default_14, _tensor_constant54)
...
怎么做/计算：`view_default_14` 展平 context；`mm_default_3` 乘 `_tensor_constant54`；`_unsafe_view_default_3` 恢复 `[1,624,4096]`；`add_tensor_4` 与 `arg0_1` 在相同 S/H 坐标逐元素相加。
...
mm_default_4 = aten.mm.default(view_default_15, _tensor_constant55)
...
mm_default_5 = aten.mm.default(view_default_16, _tensor_constant56)
...
mm_default_6 = aten.mm.default(view_default_17, _tensor_constant57)
...
examples: K[0,0,0], K[31,623,127], V[14,611,64].
```
...
| 18 | `qkv_projection` | `_tensor_constant49` | `get_attr` | `_tensor_constant49` | - | `mm_default` |
| 19 | `qkv_projection` | `mm_default` | `call_function` | `aten.mm.default` | `view_default`, `_tensor_constant49` | `_unsafe_view_default` |
...
| 22 | `qkv_projection` | `_tensor_constant50` | `get_attr` | `_tensor_constant50` | - | `mm_default_1` |
| 23 | `qkv_projection` | `mm_default_1` | `call_function` | `aten.mm.default` | `view_default_1`, `_tensor_constant50` | `_unsafe_view_default_1` |
...
| 26 | `qkv_projection` | `_tensor_constant51` | `get_attr` | `_tensor_constant51` | - | `mm_default_2` |
| 27 | `qkv_projection` | `mm_default_2` | `call_function` | `aten.mm.default` | `view_default_2`, `_tensor_constant51` | `_unsafe_view_default_2` |
...
| 35 | `rope` | `_tensor_constant52` | `get_attr` | `_tensor_constant52` | - | `index_tensor` |
| 36 | `rope` | `index_tensor` | `call_function` | `aten.index.Tensor` | `_tensor_constant52`, `arg2_1` | `unsqueeze_default` |
| 37 | `rope` | `unsqueeze_default` | `call_function` | `aten.unsqueeze.default` | `index_tensor` | `mul_tensor_2`, `mul_tensor_4` |
| 38 | `rope` | `_tensor_constant53` | `get_attr` | `_tensor_constant53` | - | `index_tensor_1` |
| 39 | `rope` | `index_tensor_1` | `call_function` | `aten.index.Tensor` | `_tensor_constant53`, `arg2_1` | `unsqueeze_default_1` |
...
| 87 | `output_projection` | `_tensor_constant54` | `get_attr` | `_tensor_constant54` | - | `mm_default_3` |
| 88 | `output_projection` | `mm_default_3` | `call_function` | `aten.mm.default` | `view_default_14`, `_tensor_constant54` | `_unsafe_view_default_3` |
...
| 101 | `mlp` | `_tensor_constant55` | `get_attr` | `_tensor_constant55` | - | `mm_default_4` |
| 102 | `mlp` | `mm_default_4` | `call_function` | `aten.mm.default` | `view_default_15`, `_tensor_constant55` | `_unsafe_view_default_4` |
...
| 106 | `mlp` | `_tensor_constant56` | `get_attr` | `_tensor_constant56` | - | `mm_default_5` |
| 107 | `mlp` | `mm_default_5` | `call_function` | `aten.mm.default` | `view_default_16`, `_tensor_constant56` | `_unsafe_view_default_5` |
...
| 111 | `mlp` | `_tensor_constant57` | `get_attr` | `_tensor_constant57` | - | `mm_default_6` |
| 112 | `mlp` | `mm_default_6` | `call_function` | `aten.mm.default` | `view_default_17`, `_tensor_constant57` | `_unsafe_view_default_6` |

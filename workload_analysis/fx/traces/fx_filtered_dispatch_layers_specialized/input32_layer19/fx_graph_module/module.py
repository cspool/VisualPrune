...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.register_buffer('_tensor_constant2', torch.empty([1, 32, 88, 128], dtype=torch.float16))
        self.register_buffer('_tensor_constant3', torch.empty([1, 32, 88, 128], dtype=torch.float16))
        ...
        self.load_state_dict(torch.load(r'/workspace/VisiPrune/workload_analysis/fx/traces/fx_filtered_dispatch_layers_specialized/input32_layer19/fx_graph_module/state_dict.pt'))

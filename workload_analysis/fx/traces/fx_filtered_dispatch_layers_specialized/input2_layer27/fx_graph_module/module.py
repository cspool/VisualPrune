...
class FxLayerGraphModule(torch.nn.Module):
    def __init__(self):
        ...
        self.register_buffer('_tensor_constant2', torch.empty([1, 32, 58, 128], dtype=torch.float16))
        self.register_buffer('_tensor_constant3', torch.empty([1, 32, 58, 128], dtype=torch.float16))
        ...
        self.load_state_dict(torch.load(r'/workspace/VisiPrune/workload_analysis/fx/traces/fx_filtered_dispatch_layers_specialized/input2_layer27/fx_graph_module/state_dict.pt'))
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1):
        ...
        expand_1 = torch.ops.aten.expand.default(transpose_3, [1, 32, 128, 59]);  transpose_3 = None
        view_7 = torch.ops.aten.view.default(expand_1, [32, 128, 59]);  expand_1 = None
        bmm = torch.ops.aten.bmm.default(view_6, view_7);  view_6 = view_7 = None
        view_8 = torch.ops.aten.view.default(bmm, [1, 32, 1, 59]);  bmm = None
        ...
        expand_2 = torch.ops.aten.expand.default(clone, [1, 32, 1, 59]);  clone = None
        view_9 = torch.ops.aten.view.default(expand_2, [32, 1, 59]);  expand_2 = None
        expand_3 = torch.ops.aten.expand.default(cat_3, [1, 32, 59, 128])
        view_10 = torch.ops.aten.view.default(expand_3, [32, 59, 128]);  expand_3 = None

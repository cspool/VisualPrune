...
def main(args):
    ...
    inp = "What is the make of car on the left?\nAnswer the question using a single word or phrase."
    ...
    outputs = tokenizer.decode(output_ids[0]).strip().replace('<s>', ' ').replace('</s>', ' ').strip()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-file", type=str, default="./images/v1_73.jpg")
